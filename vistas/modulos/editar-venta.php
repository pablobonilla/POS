    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-xs-12">
        ...
        <div class="box box-success">
          ...
          <spam class="textoFactura" >Facturación</spam>
            ...
            <div class="box-body">
              ...
              <div class="box">
                ...
                <?php
                    ...
                    $itemDelivery = "id";
                    $valorDelivery = $venta["id_delivery"];

                    $delivery = ControladorDelivery::ctrMostrarDelivery($itemDelivery, $valorDelivery);
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                   ...
                   <!--=====================================
                    ENTRADA PARA AGREGAR MESA
                    ======================================-->
                
                  
                  <!-- <div class="input-group col-xs-pull-6"> -->
                    
                  <span class="input-group-addon"> <i class="fa fa-table"></i>              Mesa:</i></span>                   
                    
                  <select class="form-control" id="seleccionarMesa" name="seleccionarMesa">

                  if (isset($mesa["id"])) {
                  <option value="<?php echo $mesa["id"]; ?>"><?php echo $mesa["nombre"]; ?></option>
                }else{
                  <option value="">Sellecionar Mesa</option>
                }
                    ...
                    <?php
                      ...
                      $categorias1 = ControladorMesas::ctrMostrarMesas($item, $valor);
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" id="seleccionarDelivery" name="seleccionarDelivery">

                    <option value="<?php echo $delivery["id"]; ?>"><?php echo $delivery["nombre"]; ?></option>
                    ...
                    <?php
                      ...
                      $categorias1 = ControladorDelivery::ctrMostrarDelivery($item, $valor);
      ...
      <div class="col-lg-6 hidden-md hidden-sm hidden-xs">
        ...
        <div class="box box-warning">
          ...
          <spam class="textoProductos" >Lista de Productos</spam>
